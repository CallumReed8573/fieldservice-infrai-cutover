...
> Design notes for **fieldservice-infrai-cutover** — a runnable python example that Route typed field-service photo reviews through an OpenAI-compatible gateway with a reversible cutover.
...
- **Feature code** — the actual task: field-service-gateway-cutover.
